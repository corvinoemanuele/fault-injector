    ...
    def save_intermediate_layer_outputs(self,
        ...
        with torch.no_grad():
            for batch_id, batch in enumerate(pbar):
                ...
                # DELETE THE COMMENT TO SAVE CLEAN FEATURE MAPS
                ...
                clean_output_batch = network_output.detach().cpu()
                ...
                clean_output_scores.append(clean_output_batch)
            ...
            # clean_inference(self.network, self.loader, self.device, 'ResNet18')
